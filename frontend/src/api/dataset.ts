...
export const datasetApi = {
  ...
  repairDataset: async (
    ...
    const res = await fetch(
      `${API_PREFIX}/datasets/${datasetId}/repair`,
      {
        method: "POST",
        headers: {
    ...
    if (!res.ok) {
      const err = await res.json().catch(() => ({ detail: res.statusText }));
      throw new Error(
        typeof err.detail === "string" ? err.detail : "Repair failed"
      );
    }
  ...
  getVersionHistory: async (
    ...
    const res = await fetch(
      `${API_PREFIX}/datasets/${datasetId}/versions`
    );
  ...
  getDatasetVersionData: async (
    ...
    const res = await fetch(
      `${API_PREFIX}/datasets/${datasetId}/versions/${versionId}`
    );
  ...
  exportDatasetVersion: async (
    datasetId: string,
    versionId: string,
    filename: string
  ): Promise<void> => {
    const res = await fetch(
      `${API_PREFIX}/datasets/${datasetId}/versions/${versionId}/download`
    );
  ...
  queryDatasetWithAI: async (
    datasetId: string,
    query: string,
    versionId: string
  ): Promise<any> => {
    const res = await fetch(
      `${API_PREFIX}/datasets/${datasetId}/ai-query`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
